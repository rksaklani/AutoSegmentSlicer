# Contributing to AutoSegmentSlicer

There are many ways to contribute to AutoSegmentSlicer.

- Submit a feature request or bug, or add to the discussion on the [AutoSegmentSlicer issue tracker][is]
- Submit a [Pull Request][pr] to improve AutoSegmentSlicer.

## The PR Process, and Related Gotchas

### How to submit a PR ?

If you are new to AutoSegmentSlicer development and you don't have push access to the AutoSegmentSlicer
...
When submitting a PR, make sure to add a `Cc: @AutoSegmentSlicer/developers` comment to
notify AutoSegmentSlicer developers of your awesome contributions. Based on the
...
- You do NOT have push access: A AutoSegmentSlicer core developer will integrate your PR.
...
[pr]: https://github.com/Kitware/AutoSegmentSlicer/merge_requests
[is]: https://github.com/Kitware/AutoSegmentSlicer/issues
